                                ...
                                <div className="col-xl-12 col-lg-4">
                                    ...
                                    <div className="card shadow mb-3 text-center">
                                            ...
                                            <tbody>
                                                {data.map((item) => (
                                                    <tr key={item.id}>
                                                        ...
                                                        <td>{item.SDT}</td>
                                                        <td>{item.ngayDatLich.slice(0, 10)} {item.ngayDatLich.slice(11, 16)}</td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <Link to={`/detailappointment/${item.id}`}>Chi Tiết</Link>
                                                        </td>
                                                    </tr>
                                                ))}
                                            </tbody>
                                        ...
                                        <div className="d-flex justify-content-end navigation">
                                            <button className="btn m-2 border border-0 bg-primary text-white" type='button'>1</button>
                                            <button className="btn m-2 border border-0" type='button'>2</button>
                                            <button className="btn m-2 border border-0" type='button'>3</button>
                                        </div>
                                    </div>
